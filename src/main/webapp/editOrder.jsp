...
<div class="container mx-auto">
    ...
    <form action="updateOrder" method="post" class="bg-white p-5 shadow-md rounded">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="userId" name="userId" value="<%= order.getUserId() %>" class="border px-4 py-2 rounded w-full" required>
        </div>

        <div class="mb-4">
            <label for="orderDate" class="block font-semibold">Ngày đặt hàng</label>
            <input type="date" id="orderDate" name="orderDate" value="<%= order.getOrderDate().toString().substring(0, 10) %>" class="border px-4 py-2 rounded w-full" required>
        </div>
