...
INSERT INTO `cart` VALUES (5, 14);
INSERT INTO `cart` VALUES (6, 22);
INSERT INTO `cart` VALUES (12, 12);
INSERT INTO `cart` VALUES (24, 20);
INSERT INTO `cart` VALUES (25, 7);
INSERT INTO `cart` VALUES (26, 10);
INSERT INTO `cart` VALUES (27, 11);
INSERT INTO `cart` VALUES (31, 17);
INSERT INTO `cart` VALUES (32, 23);
INSERT INTO `cart` VALUES (33, 24);
INSERT INTO `cart` VALUES (34, 25);
INSERT INTO `cart` VALUES (35, 26);
...
INSERT INTO `cartitems` VALUES (10, 23, 153, 'nhà mặt phố bố làm to lắm ', 50.00, 50.00, 'http://res.cloudinary.com/dg0f7bdho/image/upload/v1733236047/pgnkxhgd1zsfazhge796.jpg', 1, 'Quận 1 Thành Phố Hồ Chí Minh');
INSERT INTO `cartitems` VALUES (11, 24, 5, 'Tòa Nhà Ocean View', 50.00, 80.00, 'https://th.bing.com/th/id/OIP.hb6l6bIzr1y8STuOZcbquAHaHt?rs=1&pid=ImgDetMain', 1, '789 Trần Hưng Đạo, Hà Nội');
INSERT INTO `cartitems` VALUES (12, 24, 6, 'Nhà phố rộng rãi có sân vườn', 30.00, 150.00, 'https://sieuthibanve.com/upload/images/202202/220757-products-2021-07-07-1625648623-oo.png', 1, '456 Đường Nguyễn Huệ, Quận 2, TP.HCM');
INSERT INTO `cartitems` VALUES (13, 24, 151, 'nhà mặt phố bố làm to lắm ', 50.00, 50.00, 'http://res.cloudinary.com/dg0f7bdho/image/upload/v1733235779/jmfgwn8bxefiznuoxwri.jpg', 1, 'Quận 1 Thành Phố Hồ Chí Minh');
...
-- ----------------------------
-- Table structure for digital_signature
-- ----------------------------
DROP TABLE IF EXISTS `digital_signature`;
CREATE TABLE `digital_signature`  (
  `user_id` int NOT NULL,
  `public_key` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `dt_create` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `dt_expired` datetime NULL DEFAULT NULL,
  `is_expired` tinyint NULL DEFAULT 0,
  `is_use` tinyint NULL DEFAULT 1,
  `dt_report` datetime NULL DEFAULT NULL,
...
INSERT INTO `digital_signature` VALUES (33, '', '2024-12-12 22:34:02', '2024-12-19 22:21:01', 0, 0, '2024-12-12 21:33:00');

-- ----------------------------
-- Table structure for orderitem_logs
-- ----------------------------
DROP TABLE IF EXISTS `orderitem_logs`;
CREATE TABLE `orderitem_logs`  (
  `log_id` int NOT NULL AUTO_INCREMENT,
  `order_item_id` int NOT NULL,
  `action` enum('INSERT','UPDATE','DELETE') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `old_quantity` int NULL DEFAULT NULL,
  `new_quantity` int NULL DEFAULT NULL,
  `old_price` double NULL DEFAULT NULL,
  `new_price` double NULL DEFAULT NULL,
  `change_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `changed_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of orderitem_logs
-- ----------------------------
INSERT INTO `orderitem_logs` VALUES (1, 34, 'INSERT', NULL, 1, NULL, 300, '2024-12-12 20:51:01', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (2, 35, 'INSERT', NULL, 1, NULL, 120, '2024-12-12 20:51:01', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (5, 35, 'INSERT', NULL, 1, NULL, 50, '2024-12-12 21:54:11', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (6, 35, 'UPDATE', 1, 1, 50, 100, '2024-12-12 21:55:27', NULL, b'0');
INSERT INTO `orderitem_logs` VALUES (7, 35, 'UPDATE', 1, 1, 100, 200, '2024-12-12 21:56:36', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (8, 35, 'DELETE', 1, NULL, 200, NULL, '2024-12-12 21:57:17', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (9, 36, 'INSERT', NULL, 1, NULL, 50, '2024-12-12 22:22:51', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (10, 37, 'INSERT', NULL, 1, NULL, 30, '2024-12-12 22:22:51', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (11, 38, 'INSERT', NULL, 1, NULL, 50, '2024-12-12 22:22:51', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (12, 39, 'INSERT', NULL, 2, NULL, 50, '2024-12-12 22:24:44', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (13, 39, 'UPDATE', 2, 2, 50, 50, '2024-12-12 22:24:50', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (14, 39, 'DELETE', 2, NULL, 50, NULL, '2024-12-12 22:31:38', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (15, 39, 'INSERT', NULL, 1, NULL, 100, '2024-12-12 22:32:13', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (16, 39, 'UPDATE', 1, 1, 100, 100, '2024-12-12 22:32:23', 'root@localhost', b'0');
INSERT INTO `orderitem_logs` VALUES (17, 40, 'INSERT', NULL, 1, NULL, 100, '2024-12-12 22:40:49', 'root@localhost', b'0');
...
INSERT INTO `orderitems` VALUES (14, 32, 106, 1, 300, 'Sản phẩm 12');
INSERT INTO `orderitems` VALUES (14, 33, 89, 1, 120, 'Barr Land');
INSERT INTO `orderitems` VALUES (14, 34, 153, 2, 50, 'nhà mặt phố bố làm to lắm ');
INSERT INTO `orderitems` VALUES (15, 36, 5, 1, 50, 'Tòa Nhà Ocean View');
INSERT INTO `orderitems` VALUES (15, 37, 6, 1, 30, 'Nhà phố rộng rãi có sân vườn');
INSERT INTO `orderitems` VALUES (15, 38, 151, 1, 50, 'nhà mặt phố bố làm to lắm ');
INSERT INTO `orderitems` VALUES (15, 39, 151, 1, 100, 'nhà mặt phố bố làm to lắm');
INSERT INTO `orderitems` VALUES (13, 40, 151, 1, 100, 'nhaf');
...
CREATE TABLE `orders`  (
  ...
  `signature` varchar(10000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
INSERT INTO `orders` VALUES (32, 14, '2024-12-12 21:47:44', 'a', '123', 0, 0);
INSERT INTO `orders` VALUES (33, 15, '2024-12-12 22:21:11', 'b', '', 0, 1);
...
INSERT INTO `users` VALUES (32, 'a', 'a', 'voducminh39@gmail.com', '', 'active', 'user');
INSERT INTO `users` VALUES (33, 'b', 'b', 'voducminh39@gmail.com', NULL, 'active', 'user');
INSERT INTO `users` VALUES (34, 'c', 'c', 'voducminh39@gmail.com', NULL, 'active', 'admin');
INSERT INTO `users` VALUES (35, 'd', 'd', 'voducminh39@gmail.com', NULL, 'active', 'user');

-- ----------------------------
-- Procedure structure for change_dt_report_to_null
-- ----------------------------
DROP PROCEDURE IF EXISTS `change_dt_report_to_null`;
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `change_dt_report_to_null`(in userId int)
BEGIN
...
-- ----------------------------
-- Procedure structure for update_dt_report
-- ----------------------------
DROP PROCEDURE IF EXISTS `update_dt_report`;
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_dt_report`(in user_id int,
in dt_report DATETIME)
BEGIN
	UPDATE digital_signature
    SET dt_report = dt_report,is_use = 0
    WHERE digital_signature.user_id = user_id;
		
		call update_is_report(user_id);
END
;;
delimiter ;

-- ----------------------------
-- Procedure structure for update_is_expired
-- ----------------------------
DROP PROCEDURE IF EXISTS `update_is_expired`;
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_is_expired`(in userId int,in val int)
BEGIN
UPDATE digital_signature
    SET is_expired = val
...
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_is_expired_to_0`(in userId int)
BEGIN
	update digital_signature
	set is_expired = 0
	where user_id = userId;
...
-- ----------------------------
-- Procedure structure for update_is_report
-- ----------------------------
DROP PROCEDURE IF EXISTS `update_is_report`;
delimiter ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_is_report`(in userId int)
BEGIN
DECLARE dt_rp DATETIME;

    -- Lấy giá trị dt_report mới nhất từ bảng digital_signature
    SELECT MAX(dt_report) INTO dt_rp 
    FROM digital_signature;

    -- Cập nhật bảng orderitems dựa trên điều kiện so sánh với dt_rp
    UPDATE orders
    SET verify = 0, 
        is_report = 1
    WHERE order_date > dt_rp and user_id = userId;
END
;;
delimiter ;
...
-- ----------------------------
DROP TRIGGER IF EXISTS `orderitems_after_update`;
delimiter ;;
CREATE TRIGGER `orderitems_after_update` AFTER UPDATE ON `orderitems` FOR EACH ROW BEGIN
  INSERT INTO `orderitem_logs` (`order_item_id`, `action`, `old_quantity`, `new_quantity`, `old_price`, `new_price`, `change_time`, `changed_by`)
  VALUES (OLD.`order_item_id`, 'UPDATE', OLD.`quantity`, NEW.`quantity`, OLD.`price`, NEW.`price`, NOW(), USER());
END
;;
delimiter ;
...
-- Triggers structure for table orderitems
-- ----------------------------
DROP TRIGGER IF EXISTS `orderitems_after_delete`;
delimiter ;;
CREATE TRIGGER `orderitems_after_delete` AFTER DELETE ON `orderitems` FOR EACH ROW BEGIN
  INSERT INTO `orderitem_logs` (`order_item_id`, `action`, `old_quantity`, `old_price`, `change_time`,`changed_by`)
  VALUES (OLD.`order_item_id`, 'DELETE', OLD.`quantity`, OLD.`price`, NOW(), USER());
END
;;
delimiter ;
...
-- Triggers structure for table orderitems
-- ----------------------------
DROP TRIGGER IF EXISTS `orderitems_after_insert`;
delimiter ;;
CREATE TRIGGER `orderitems_after_insert` AFTER INSERT ON `orderitems` FOR EACH ROW BEGIN
  INSERT INTO `orderitem_logs` (`order_item_id`, `action`, `new_quantity`, `new_price`, `change_time`,`changed_by`)
  VALUES (NEW.`order_item_id`, 'INSERT', NEW.`quantity`, NEW.`price`, NOW(), USER());
  UPDATE orders SET verify=0 WHERE NEW.`order_id`= order_id;
END
;;
delimiter ;
